...
required = [
    ...
    "FORMALISATION_PLAN.md", "O0_SOURCE_FREEZE.md", "O1_DETECTOR_ADMISSIBILITY.md",
    "O1_EXECUTION.md", "O2_RANDOM_COVER_DUAL.md", "O2_EXECUTION.md",
    "O3_DEGREE_COEFFICIENT_COST.md", "O3_EXECUTION.md",
    "O4_CONNECTED_CUMULANT_COMPRESSION.md", "O4_EXECUTION.md",
    "O5_ARITHMETIC_CONNECTED_CORRELATIONS.md", "O5_EXECUTION.md",
    "O6_CONDITIONAL_POISSON_BENCHMARK.md", "O6_EXECUTION.md",
    "O7_ROWWISE_PARITY_BREAKING.md", "O7_EXECUTION.md",
    "O8_FALSIFICATION_AND_SMALL_PANELS.md", "O8_EXECUTION.md", "STATUS.md",
]
for rel in required:
    path = PROGRAMME / rel
    if not path.is_file():
...
assert contract["status"] in {
    "BUILT_NOT_EXECUTED", "EXECUTING", "RESEARCH_COMPLETE_VALIDATION_PENDING", "CLOSED"
}
assert contract["detector_admissibility"]["weights_must_be_frozen_before_output_prime_incidence"] is True
...
for required_claim in {
    "O1-GENERIC-DETECTOR", "O1-WEIGHTED-DETECTOR", "O2-BERNOULLI-COVER",
    "O2-HYPERGEOMETRIC-COVER", "O3-DEGREE-COST", "O3-ADAPTIVE-SCALE",
    "O4-GLOBAL-MIXTURE-OBSTRUCTION", "O4-INT-SOCB", "O5-JOINT-CUMULANT",
    "O5-COMPLETE-DEPENDENCY", "O5-INT-SOCG", "O6-RUHL-IMPLICATION",
    "O7-ROWWISE-BILINEAR", "O8-NO_FINITE_PROMOTION",
}:
...
lean = ROOT / "fortune-formal" / "FortuneFormal" / "Integer" / "AdaptiveOccupancyCriterion.lean"
...
scripts = [
    "verify_detector_implication.py", "verify_random_cover.py", "verify_scale_ledger.py",
    "verify_factorial_cumulants.py", "verify_adversarial_private_columns.py",
    "verify_poisson_mixture_obstruction.py", "verify_stratified_criterion.py",
    "verify_joint_cumulant_decomposition.py", "verify_socg_implication.py",
    "verify_ruhl_budget.py",
]
for script in scripts:
    subprocess.run([sys.executable, str(PROGRAMME / "scripts" / script)], check=True)

for diagnostic in ("run_exact_primorial_panels.py", "run_stratified_panel_diagnostics.py"):
