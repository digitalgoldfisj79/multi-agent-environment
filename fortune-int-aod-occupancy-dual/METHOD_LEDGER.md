...
| Asymptotic sieve | Closed as direct application | New rowwise parity-breaking bilinear theorem | O7 |
| Weighted switching | Closed as direct actual-prime route | Distribution in both coordinates and signed sparse-hyperbola control | O7 |
| Rowwise primorial bilinear hyperbola | Valid secondary sufficient theorem | `INT-RPBH` | O7 |
| Exact small primorial computation | Diagnostic only | None | O8 |
| Adversarial incidence models | Falsification passed | Any proposed statistic must distinguish the registered surrogates | O8 |

## Non-negotiable distinctions

1. An identity is not an estimate.
2. A local singular-series average is not a prime-tuple count.
3. A conditional Hardy--Littlewood benchmark is not an unconditional Fortune result.
