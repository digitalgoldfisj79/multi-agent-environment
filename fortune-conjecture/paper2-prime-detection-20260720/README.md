...
## Reciprocal frames, exact moments, and structural obstructions
...
The paper proves exact reductions, moment formulas, and route-specific obstruction theorems. It isolates two open theorem boundaries:

1. a complete shifted-von-Mangoldt block variance at primorial centres;
2. a weighted one-sided reciprocal sampling estimate for the consecutive-prime prefix-product walk.

Neither open estimate is proved.

## Cold-review outcome

The independent review found no mathematical error in the theorem layer and classified the manuscript as conditionally ready subject to a short pre-submission fix list. Rev. 1 implements that list, including the offset-one correction to Lemma 2.2 and the refreshed reproducibility records.
