...
The archive contains exact proofs, route-specific no-go results, and finite computational diagnostics. They are not interchangeable. `CURRENT_STATUS.md` separates these categories.

The active PGD2/SHF2/PC-FROB2 objects are unproved sufficient targets within the current architecture. No claim is made that they are logically necessary for every possible proof of Fortune's conjecture.
